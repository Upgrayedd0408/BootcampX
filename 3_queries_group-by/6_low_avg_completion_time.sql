...
SELECT students.name as student_name, avg(assignment_submissions.duration) as avg_completion_time, avg(assignments.duration) as suggested_avg_completion_time
